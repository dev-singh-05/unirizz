                            ...
                            <a href="https://drive.google.com/uc?export=download&id=1I_-k32m49njyfEqPfkcl-xPcWJOvW6YQ" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                                <Button size="lg" variant="outline" className="h-14 px-8 cursor-pointer text-lg gap-2 border-primary/20 bg-primary/5 hover:bg-primary/10 rounded-full w-full sm:w-auto hover:transform hover:-translate-y-1 transition-all">
                                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                        ...
                                        <path d="M3 20.5v-17c0-.83.67-1.5 1.5-1.5.2 0 .4.04.58.12l10.5 7.63-2.6 1.89L4.5 3.37C4.2 3.12 3.82 2.97 3.4 3c-.77.05-1.4.67-1.4 1.45v15.1c0 .78.63 1.4 1.4 1.45.42.03.8-.12 1.1-.37l8.48-8.26 2.6 1.89-10.5 7.63c-.18.08-.38.12-.58.12-.83 0-1.5-.67-1.5-1.5z" />
                                    </svg>
                                    Android
                                </Button>
                            </a>
                        </div>
                        <p className="text-sm text-muted-foreground mt-2 font-medium">Campus-exclusive • For students only</p>
                    </div>

                    {/* Image Content */}
                    <div className="relative flex justify-center lg:justify-end mt-12 lg:mt-0">
                        {/* Glow effect behind phone */}
                        <div className="absolute inset-0 bg-gradient-to-tr from-primary/30 to-accent/30 blur-[100px] rounded-full opacity-60 transform scale-75 animate-pulse" />

                        <div className="relative z-10 w-[280px] sm:w-[300px] md:w-[350px] lg:w-[320px] animate-float">
                            <Image
                                src="/app-mockup.png"
                                alt="UniRizz App Interface"
                                width={800}
                                height={1600}
                                className="rounded-[3rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] border-8 border-zinc-900"
                                priority
                            />
                        </div>
                    </div>
