                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col gap-6 items-center lg:items-start text-center lg:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4 justify-center lg:justify-start">
                            <Button size="lg" className="h-14 cursor-pointer px-8 text-lg gap-2 bg-foreground text-background hover:bg-foreground/90 rounded-full w-full sm:w-auto">
                            ...
                            <a href="https://drive.google.com/uc?export=download&id=1I_-k32m49njyfEqPfkcl-xPcWJOvW6YQ" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                                <Button size="lg" variant="outline" className="h-14 px-8 cursor-pointer text-lg gap-2 border-primary/20 bg-primary/5 hover:bg-primary/10 rounded-full w-full sm:w-auto">
                                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                    ...
                    <div className="relative flex justify-center lg:justify-end mt-12 lg:mt-0">
                        ...
                        <div className="relative z-10 w-[280px] sm:w-[300px] md:w-[350px] lg:w-[400px]">
                            <Image
                                src="/app-mockup.png"
