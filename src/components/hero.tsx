                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col gap-6 items-start text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
                            <Button size="lg" className="h-14 px-8 text-lg gap-2 bg-foreground text-background hover:bg-foreground/90 rounded-full">
                            ...
                            <Button size="lg" variant="outline" className="h-14 px-8 text-lg gap-2 border-primary/20 bg-primary/5 hover:bg-primary/10 rounded-full">
                                <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
